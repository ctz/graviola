...
macro_rules! amontred {
    ($P:expr) => { Q!(
        /* We only know the input is -2^316 < x < 2^316. To do traditional  */ /* unsigned Montgomery reduction, start by adding 2^61 * p_256.     */ "mov r8, 0xe000000000000000;"
        "add r8, [" $P "];"
        ...
        "adc r12, [" $P "+ 32];"
        /* Let [r8;rbx] = 2^32 * w and [rdx;rax] = (2^64 - 2^32 + 1) * w */ /* where w is the lowest word */ "mov rbx, r8;"
        "shl rbx, 32;"
        "mov rax, 0xffffffff00000001;"
        "mul r8;"
        "shr r8, 32;"
        /* Hence basic addition of (2^256 - 2^224 + 2^192 + 2^96) * w */ "add r9, rbx;"
        "adc r10, r8;"
        "adc r11, rax;"
        "adc r12, rdx;"
        /* Now capture carry and subtract p_256 if set (almost-Montgomery) */ "sbb rax, rax;"
...
pub fn bignum_inv_p256(z: &mut [u64; 4], x: &[u64; 4]) {
    unsafe {
        core::arch::asm!(
