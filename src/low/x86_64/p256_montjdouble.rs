...
macro_rules! cmsub_p256 {
    ($P0:expr, $C:expr, $P1:expr, $D:expr, $P2:expr) => { Q!(
        /* First [r11;r10;r9;r8] = p_256 - P2 */ "mov r8, 0xffffffffffffffff;"
        "xor r10d, r10d;"
        "sub r8, [" $P2 "];"
        ...
        "sbb r11, [" $P2 "+ 0x18];"
        /* [r12;r11;r10;r9;r8] = D * (p_256 - P2) */ "xor r12d, r12d;"
        "mov rdx, " $D ";"
        "mulx rax, r8, r8;"
        "mulx rcx, r9, r9;"
        "add r9, rax;"
        ...
        "adc r11, rax;"
        "adc r12, rcx;"
        /* [rdx;r11;r10;r9;r8] = 2^256 + C * P1 + D * (p_256 - P2) */ "mov rdx, " $C ";"
        "xor eax, eax;"
        "mulx rcx, rax, [" $P1 "];"
        "adcx r8, rax;"
        "adox r9, rcx;"
        ...
        "adox rdx, r12;"
        "adc rdx, 1;"
        /* Now the tail for modular reduction from tripling */ "add r8, rdx;"
        "mov rax, 0x100000000;"
        "mulx rcx, rax, rax;"
        "sbb rax, 0x0;"
        "sbb rcx, 0x0;"
...
macro_rules! cmsub38_p256 {
    ($P0:expr, $P1:expr, $P2:expr) => { Q!(
        ...
        "mov r11, 0xffffffff00000001;"
        "sbb r11, [" $P2 "+ 0x18];"
        /* [r12;r11;r10;r9;r8] = (p_256 - P2) << 3 */ "mov r12, r11;"
        "shld r11, r10, 3;"
        "shld r10, r9, 3;"
        "shld r9, r8, 3;"
        "shl r8, 3;"
        "shr r12, 61;"
        /* [rdx;r11;r10;r9;r8] = 2^256 + 3 * P1 + 8 * (p_256 - P2) */ "mov rdx, 3;"
        "xor eax, eax;"
        "mulx rcx, rax, [" $P1 "];"
        "adcx r8, rax;"
        "adox r9, rcx;"
