...
pub fn bignum_ksqr_16_32(z: &mut [u64], x: &[u64], t: &mut [u64]) {
    ...
    unsafe {
        ...
        Q!("    mov             " "x24, x1"),
        Q!("    mov             " "x25, x2"),
        Q!("    bl              " Label!("bignum_ksqr_16_32_neon_local_sqr_8_16", 2, After)),
        Q!("    ldp             " "x10, x11, [x24]"),
        Q!("    ldp             " "x8, x9, [x24, #64]"),
        Q!("    subs            " "x10, x10, x8"),
        Q!("    sbcs            " "x11, x11, x9"),
        ...
        Q!("    ldp             " "x21, x22, [sp], #16"),
        Q!("    ldp             " "x19, x20, [sp], #16"),
        // proc hoisting in -> ret after bignum_ksqr_16_32_neon_local_sqr_8_16
        Q!("    b               " Label!("hoist_finish", 3, After)),

        Q!(Label!("bignum_ksqr_16_32_neon_local_sqr_8_16", 2) ":"),
        Q!("    ldp             " "x2, x3, [x1]"),
        Q!("    ldr             " "q20, [x1]"),
        Q!("    ldp             " "x4, x5, [x1, #16]"),
        Q!("    ldr             " "q21, [x1, #16]"),
