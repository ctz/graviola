...
pub fn bignum_emontredc_8n(z: &mut [u64], m: &[u64], w: u64) -> u64 {
    ...
    unsafe {
        ...
        Q!("    mov             " "x26, x0"),
        Q!("    subs            " "x12, x0, #0x1"),
        Q!("    b.cc            " Label!("bignum_emontredc_8n_neon_end", 2, After)),
        Q!("    stp             " "x3, xzr, [sp]"),
        Q!("    stp             " "x26, xzr, [sp, #16]"),
        Q!("    mov             " "x28, xzr"),
        Q!("    lsl             " "x0, x12, #5"),

        Q!(Label!("bignum_emontredc_8n_neon_outerloop", 3) ":"),
        Q!("    ldp             " "x3, xzr, [sp]"),
        Q!("    ldp             " "x17, x19, [x1]"),
        Q!("    ldp             " "x20, x21, [x1, #16]"),
        Q!("    ldp             " "x8, x9, [x2]"),
        ...
        Q!("    cbz             " "x0, " Label!("bignum_emontredc_8n_neon_madddone", 4, After)),
        Q!("    mov             " "x27, x0"),
        Q!("    cmp             " "x0, #0x20"),
        Q!("    b.ne            " Label!("bignum_emontredc_8n_neon_maddloop_neon_firstitr", 5, After)),

        Q!(Label!("bignum_emontredc_8n_neon_maddloop_x0one", 6) ":"),
        Q!("    add             " "x2, x2, #0x20"),
        Q!("    add             " "x1, x1, #0x20"),
        Q!("    mul             " "x17, x4, x8"),
        Q!("    mul             " "x22, x5, x9"),
        ...
        Q!("    stp             " "x20, x21, [x1, #16]"),
        Q!("    sub             " "x27, x27, #0x20"),
        Q!("    b               " Label!("bignum_emontredc_8n_neon_madddone", 4, After)),

        Q!(Label!("bignum_emontredc_8n_neon_maddloop_neon_firstitr", 5) ":"),
        Q!("    mov             " "x16, v25.d[0]"),
        Q!("    mov             " "x22, v24.d[1]"),
        Q!("    mov             " "x20, v25.d[1]"),
        Q!("    mov             " "x23, v26.d[0]"),
        ...
        Q!("    sub             " "x27, x27, #0x20"),
        Q!("    cmp             " "x27, #0x20"),
        Q!("    b.eq            " Label!("bignum_emontredc_8n_neon_maddloop_neon_last", 7, After)),

        Q!(Label!("bignum_emontredc_8n_neon_maddloop_neon", 8) ":"),
        Q!("    ldp             " "x8, x9, [x2, #32]"),
        Q!("    ldp             " "x10, x11, [x2, #48]"),
        Q!("    ldr             " "q22, [x2, #64]"),
        Q!("    ldr             " "q23, [x2, #80]"),
        ...
        Q!("    sub             " "x27, x27, #0x20"),
        Q!("    cmp             " "x27, #0x20"),
        Q!("    b.ne            " Label!("bignum_emontredc_8n_neon_maddloop_neon", 8, Before)),

        Q!(Label!("bignum_emontredc_8n_neon_maddloop_neon_last", 7) ":"),
        Q!("    ldp             " "x8, x9, [x2, #32]"),
        Q!("    ldp             " "x10, x11, [x2, #48]"),
        Q!("    add             " "x2, x2, #0x20"),
        Q!("    add             " "x1, x1, #0x20"),
        ...
        Q!(Label!("bignum_emontredc_8n_neon_madddone", 4) ":"),
        Q!("    ldp             " "x17, x19, [x1, #32]"),
        Q!("    ldp             " "x20, x21, [x1, #48]"),
        Q!("    ldp             " "x26, xzr, [sp, #16]"),
        Q!("    cmn             " "x28, x28"),
        ...
        Q!("    subs            " "x26, x26, #0x1"),
        Q!("    stp             " "x26, xzr, [sp, #16]"),
        Q!("    b.ne            " Label!("bignum_emontredc_8n_neon_outerloop", 3, Before)),
        Q!("    neg             " "x0, x28"),

        Q!(Label!("bignum_emontredc_8n_neon_end", 2) ":"),
        Q!("    add             " "sp, sp, #0x20"),
        Q!("    ldp             " "x27, x28, [sp], #16"),
        Q!("    ldp             " "x25, x26, [sp], #16"),
        Q!("    ldp             " "x23, x24, [sp], #16"),
