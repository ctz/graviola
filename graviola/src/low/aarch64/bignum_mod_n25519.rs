...
pub(crate) fn bignum_mod_n25519(z: &mut [u64; 4], x: &[u64]) {
    ...
    unsafe {
        ...
        Q!("    cbz             " k!() ", " Label!("writeback", 3, After)),
        ...
        Q!("    stp             " m0!() ", " m1!() ", [" z!() "]"),
        Q!("    stp             " m2!() ", " m3!() ", [" z!() ", #16]"),
        // linear hoisting in -> b after short
        ...
        Q!("    cbz             " k!() ", " Label!("writeback", 3, Before)),
        Q!("    ldr             " m0!() ", [" x!() "]"),
        Q!("    subs            " k!() ", " k!() ", #1"),
        Q!("    beq             " Label!("writeback", 3, Before)),
        Q!("    ldr             " m1!() ", [" x!() ", #8]"),
        Q!("    subs            " k!() ", " k!() ", #1"),
        Q!("    beq             " Label!("writeback", 3, Before)),
        Q!("    ldr             " m2!() ", [" x!() ", #16]"),
        Q!("    b               " Label!("writeback", 3, Before)),
