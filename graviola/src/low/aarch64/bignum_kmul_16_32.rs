...
pub fn bignum_kmul_16_32(z: &mut [u64], x: &[u64], y: &[u64], t: &mut [u64]) {
    ...
    unsafe {
        ...
        Q!("    mov             " "x27, x2"),
        Q!("    mov             " "x28, x3"),
        Q!("    bl              " Label!("bignum_kmul_16_32_neon_local_mul_8_16", 2, After)),
        Q!("    ldp             " "x10, x11, [x26]"),
        Q!("    ldp             " "x8, x9, [x26, #64]"),
        Q!("    subs            " "x10, x10, x8"),
        Q!("    sbcs            " "x11, x11, x9"),
        ...
        Q!("    ldp             " "x21, x22, [sp], #16"),
        Q!("    ldp             " "x19, x20, [sp], #16"),
        // proc hoisting in -> ret after bignum_kmul_16_32_neon_local_mul_8_16
        Q!("    b               " Label!("hoist_finish", 3, After)),

        Q!(Label!("bignum_kmul_16_32_neon_local_mul_8_16", 2) ":"),
        Q!("    ldp             " "x3, x4, [x1]"),
        Q!("    ldr             " "q0, [x1]"),
        Q!("    ldp             " "x7, x8, [x2]"),
        Q!("    ldr             " "q1, [x2]"),
