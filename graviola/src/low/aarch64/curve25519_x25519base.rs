...
pub(crate) fn curve25519_x25519base(res: &mut [u64; 4], scalar: &[u64; 4]) {
    ...
    unsafe {
        ...
        Q!("    adrp            " tab!() ", " PageRef!("curve25519_x25519base_alt_constant")),
        Q!("    add             " tab!() ", " tab!() ", " PageOffRef!("curve25519_x25519base_alt_constant")),
        ...
        Q!(Label!("Lcurve25519_x25519base_alt_scalarloop", 2) ":"),
        ...
        Q!("    add             " i!() ", " i!() ", 4"),
        Q!("    cmp             " i!() ", 256"),
        Q!("    bcc             " Label!("Lcurve25519_x25519base_alt_scalarloop", 2, Before)),
        ...
        Q!("    mov             " "x21, #0xa"),
        Q!("    mov             " "x22, #0x1"),
        Q!("    b               " Label!("Lcurve25519_x25519base_alt_invmidloop", 3, After)),
        Q!(Label!("Lcurve25519_x25519base_alt_invloop", 4) ":"),
        Q!("    cmp             " "x10, xzr"),
        Q!("    csetm           " "x14, mi"),
        Q!("    cneg            " "x10, x10, mi"),
        Q!("    cmp             " "x11, xzr"),
        ...
        Q!("    stp             " "x0, x1, [sp, #96]"),
        Q!("    stp             " "x3, x2, [sp, #112]"),
        Q!(Label!("Lcurve25519_x25519base_alt_invmidloop", 3) ":"),
        Q!("    mov             " "x1, x22"),
        Q!("    ldr             " "x2, [sp]"),
        Q!("    ldr             " "x3, [sp, #32]"),
        Q!("    and             " "x4, x2, #0xfffff"),
        ...
        Q!("    mov             " "x22, x1"),
        Q!("    subs            " "x21, x21, #0x1"),
        Q!("    b.ne            " Label!("Lcurve25519_x25519base_alt_invloop", 4, Before)),
        Q!("    ldr             " "x0, [sp]"),
        Q!("    ldr             " "x1, [sp, #32]"),
        Q!("    mul             " "x0, x0, x10"),
        Q!("    madd            " "x1, x1, x11, x0"),
        ...
        curve25519_x25519base_alt_constant = sym curve25519_x25519base_alt_constant,
        // clobbers
        out("x10") _,
        out("x11") _,
        out("x12") _,
...
static curve25519_x25519base_alt_constant: [u64; 6072] = [
