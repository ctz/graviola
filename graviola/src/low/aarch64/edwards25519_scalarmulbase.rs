...
macro_rules! tabent { () => { Q!("sp, # (1 * " NUMSIZE!() ")") } }
macro_rules! ymx_2 { () => { Q!("sp, # (1 * " NUMSIZE!() ")") } }
macro_rules! xpy_2 { () => { Q!("sp, # (2 * " NUMSIZE!() ")") } }
macro_rules! kxy_2 { () => { Q!("sp, # (3 * " NUMSIZE!() ")") } }

macro_rules! acc { () => { Q!("sp, # (4 * " NUMSIZE!() ")") } }
macro_rules! x_1 { () => { Q!("sp, # (4 * " NUMSIZE!() ")") } }
macro_rules! y_1 { () => { Q!("sp, # (5 * " NUMSIZE!() ")") } }
macro_rules! z_1 { () => { Q!("sp, # (6 * " NUMSIZE!() ")") } }
macro_rules! w_1 { () => { Q!("sp, # (7 * " NUMSIZE!() ")") } }
macro_rules! x_3 { () => { Q!("sp, # (4 * " NUMSIZE!() ")") } }
macro_rules! y_3 { () => { Q!("sp, # (5 * " NUMSIZE!() ")") } }
macro_rules! z_3 { () => { Q!("sp, # (6 * " NUMSIZE!() ")") } }
macro_rules! w_3 { () => { Q!("sp, # (7 * " NUMSIZE!() ")") } }

macro_rules! tmpspace { () => { Q!("sp, # (8 * " NUMSIZE!() ")") } }
macro_rules! t0 { () => { Q!("sp, # (8 * " NUMSIZE!() ")") } }
macro_rules! t1 { () => { Q!("sp, # (9 * " NUMSIZE!() ")") } }
macro_rules! t2 { () => { Q!("sp, # (10 * " NUMSIZE!() ")") } }
macro_rules! t3 { () => { Q!("sp, # (11 * " NUMSIZE!() ")") } }
macro_rules! t4 { () => { Q!("sp, # (12 * " NUMSIZE!() ")") } }
macro_rules! t5 { () => { Q!("sp, # (13 * " NUMSIZE!() ")") } }
...
/// Given a scalar n, returns point (X,Y) = n * B where B = (...,4/5) is
/// the standard basepoint for the edwards25519 (Ed25519) curve.
pub(crate) fn edwards25519_scalarmulbase(res: &mut [u64; 8], scalar: &[u64; 4]) {
    ...
    unsafe {
        ...
        Q!("    and             " "x9, x9, #0x8000000000000000"),
        Q!("    orr             " "x13, x13, x9"),
        ...
        Q!("    tst             " "x13, #0x0800000000000000"),
        Q!("    bic             " "x13, x13, #0x0800000000000000"),
        ...
        Q!("    adrp            " "x10, " PageRef!("edwards25519_scalarmulbase_alt_edwards25519_0g")),
        Q!("    adrp            " "x11, " PageRef!("edwards25519_scalarmulbase_alt_edwards25519_251g")),
        Q!("    ldp             " "x0, x1, [x10]"),
        Q!("    ldp             " "x2, x3, [x11]"),
        Q!("    csel            " "x0, x0, x2, eq"),
        Q!("    csel            " "x1, x1, x3, eq"),
        ...
        Q!("    mov             " i!() ", 0"),
        Q!("    adrp            " tab!() ", " PageRef!("edwards25519_scalarmulbase_alt_edwards25519_gtable")),
        Q!("    mov             " bias!() ", xzr"),

        // Start of the main loop, repeated 63 times for i = 0, 4, 8, ..., 248

        Q!(Label!("edwards25519_scalarmulbase_alt_scalarloop", 2) ":"),
        ...
        Q!("    add             " i!() ", " i!() ", 4"),
        Q!("    cmp             " i!() ", 252"),
        Q!("    bcc             " Label!("edwards25519_scalarmulbase_alt_scalarloop", 2, Before)),
        ...
        Q!("    ldp             " "x0, x1, [" x_3!() "]"),
        Q!("    ldp             " "x2, x3, [" x_3!() "+ 16]"),
        Q!("    mov             " "x4, #0xffffffffffffffda"),
        Q!("    subs            " "x4, x4, x0"),
        Q!("    mov             " "x7, #0xffffffffffffffff"),
        Q!("    sbcs            " "x5, x7, x1"),
        Q!("    sbcs            " "x6, x7, x2"),
        Q!("    sbc             " "x7, x7, x3"),
        Q!("    ldr             " "x10, [" scalar!() "+ 24]"),
        ...
        Q!("    mov             " "x21, #0xa"),
        Q!("    mov             " "x22, #0x1"),
        Q!("    b               " Label!("edwards25519_scalarmulbase_alt_invmidloop", 3, After)),
        Q!(Label!("edwards25519_scalarmulbase_alt_invloop", 4) ":"),
        Q!("    cmp             " "x10, xzr"),
        Q!("    csetm           " "x14, mi"),
        Q!("    cneg            " "x10, x10, mi"),
        Q!("    cmp             " "x11, xzr"),
        ...
        Q!("    stp             " "x0, x1, [sp, #96]"),
        Q!("    stp             " "x3, x2, [sp, #112]"),
        Q!(Label!("edwards25519_scalarmulbase_alt_invmidloop", 3) ":"),
        Q!("    mov             " "x1, x22"),
        Q!("    ldr             " "x2, [sp]"),
        Q!("    ldr             " "x3, [sp, #32]"),
        Q!("    and             " "x4, x2, #0xfffff"),
        ...
        Q!("    mov             " "x22, x1"),
        Q!("    subs            " "x21, x21, #0x1"),
        Q!("    b.ne            " Label!("edwards25519_scalarmulbase_alt_invloop", 4, Before)),
        Q!("    ldr             " "x0, [sp]"),
        Q!("    ldr             " "x1, [sp, #32]"),
        Q!("    mul             " "x0, x0, x10"),
        Q!("    madd            " "x1, x1, x11, x0"),
        ...
        edwards25519_scalarmulbase_alt_edwards25519_0g = sym edwards25519_scalarmulbase_alt_edwards25519_0g,
        edwards25519_scalarmulbase_alt_edwards25519_251g = sym edwards25519_scalarmulbase_alt_edwards25519_251g,
        edwards25519_scalarmulbase_alt_edwards25519_gtable = sym edwards25519_scalarmulbase_alt_edwards25519_gtable,
        // clobbers
        out("x10") _,
        out("x11") _,
        out("x12") _,
...
static edwards25519_scalarmulbase_alt_edwards25519_0g: PageAlignedu64Array12 =
    PageAlignedu64Array12([
        0x0000000000000000,
        0x0000000000000000,
        0x0000000000000000,
        0x0000000000000000,
...
static edwards25519_scalarmulbase_alt_edwards25519_251g: PageAlignedu64Array12 =
    PageAlignedu64Array12([
        0x525f946d7c7220e7,
        0x4636b0b2f1e35444,
        0x796e9d70e892ae0f,
...
static edwards25519_scalarmulbase_alt_edwards25519_gtable: PageAlignedu64Array6048 =
