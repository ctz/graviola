...
pub fn bignum_kmul_32_64(z: &mut [u64], x: &[u64], y: &[u64], t: &mut [u64]) {
    ...
    unsafe {
        ...
        Q!("    mov             " "x21, x2"),
        Q!("    mov             " "x22, x3"),
        Q!("    bl              " Label!("bignum_kmul_32_64_neon_local_kmul_16_32", 2, After)),
        Q!("    add             " "x0, x19, #0x100"),
        Q!("    add             " "x1, x20, #0x80"),
        Q!("    add             " "x2, x21, #0x80"),
        Q!("    mov             " "x3, x22"),
        ...
        Q!("    ldp             " "x21, x22, [sp], #16"),
        Q!("    ldp             " "x19, x20, [sp], #16"),
        // proc hoisting in -> ret after bignum_kmul_32_64_neon_local_mul_8_16
        Q!("    b               " Label!("hoist_finish", 3, After)),

        Q!(Label!("bignum_kmul_32_64_neon_local_kmul_16_32", 2) ":"),
        Q!("    stp             " "x19, x20, [sp, #-16] !"),
        Q!("    stp             " "x21, x22, [sp, #-16] !"),
        Q!("    stp             " "x23, x30, [sp, #-16] !"),
        Q!("    mov             " "x25, x0"),
        ...
        Q!("    mov             " "x27, x2"),
        Q!("    mov             " "x28, x3"),
        Q!("    bl              " Label!("bignum_kmul_32_64_neon_local_mul_8_16", 4, After)),
        Q!("    ldp             " "x10, x11, [x26]"),
        Q!("    ldp             " "x8, x9, [x26, #64]"),
        Q!("    subs            " "x10, x10, x8"),
        Q!("    sbcs            " "x11, x11, x9"),
        ...
        Q!(Label!("bignum_kmul_32_64_neon_local_mul_8_16", 4) ":"),
        Q!("    ldp             " "x3, x4, [x1]"),
        Q!("    ldr             " "q0, [x1]"),
        Q!("    ldp             " "x7, x8, [x2]"),
        Q!("    ldr             " "q1, [x2]"),
