...
pub(crate) fn bignum_emontredc_8n(z: &mut [u64], m: &[u64], w: u64) -> u64 {
    ...
    unsafe {
        ...
        Q!("    xor             " "eax, eax"),
        Q!("    shr             " "rdi, 0x3"),
        Q!("    je              " Label!("Lbignum_emontredc_8n_end", 2, After)),
        Q!("    lea             " "rbx, [rdi -0x1]"),
        Q!("    shl             " "rbx, 0x6"),
        Q!("    push            " "rbx"),
        Q!("    push            " "rdi"),
        ...
        Q!("    test            " "rax, rax"),
        Q!("    je              " Label!("Lbignum_emontredc_8n_innerend", 4, After)),
        Q!("    mov             " "QWORD PTR [rsp + 0x8], rax"),

        Q!(Label!("Lbignum_emontredc_8n_innerloop", 5) ":"),
        Q!("    add             " "rbp, 0x40"),
        Q!("    add             " "rdi, 0x40"),
        ...
        Q!("    jne             " Label!("Lbignum_emontredc_8n_innerloop", 5, Before)),
        Q!("    mov             " "rax, QWORD PTR [rsp + 0x18]"),

        Q!(Label!("Lbignum_emontredc_8n_innerend", 4) ":"),
        Q!("    sub             " "rdi, rax"),
        ...
        Q!("    jne             " Label!("Lbignum_emontredc_8n_outerloop", 3, Before)),
        Q!("    pop             " "rax"),
        Q!("    add             " "rsp, 0x18"),
