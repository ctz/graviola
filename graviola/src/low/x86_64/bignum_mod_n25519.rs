...
pub(crate) fn bignum_mod_n25519(z: &mut [u64; 4], x: &[u64]) {
    ...
    unsafe {
        ...
        Q!("    pop             " "rbp"),
        Q!("    pop             " "rbx"),
        // linear hoisting in -> jmp after shortinput
        Q!("    jmp             " Label!("hoist_finish", 5, After)),

        Q!(Label!("shortinput", 2) ":"),
        ...
        Q!("    jz              " Label!("writeback", 3, Before)),
        Q!("    mov             " m2!() ", [rdx + 16]"),
        Q!("    jmp             " Label!("writeback", 3, Before)),
