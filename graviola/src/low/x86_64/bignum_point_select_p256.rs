...
/// precomputed points.
pub(crate) fn bignum_aff_point_select_p256(z: &mut [u64; 8], table: &[u64], index: u64) {
    unsafe { _select_p256(z, table, index) }
}

#[target_feature(enable = "avx,avx2")]
unsafe fn _select_p256(z: &mut [u64; 8], table: &[u64], index: u64) {
