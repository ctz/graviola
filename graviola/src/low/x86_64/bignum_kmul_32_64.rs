...
pub(crate) fn bignum_kmul_32_64(z: &mut [u64], x: &[u64], y: &[u64], t: &mut [u64; 96]) {
    ...
    unsafe {
        ...
        Q!("    push            " "rcx"),
        Q!("    mov             " "rcx, rdx"),
        Q!("    call            " Label!("Lbignum_kmul_32_64_local_bignum_kmul_16_32", 2, After)),
        Q!("    lea             " "rdi, [rdi + 0xc0]"),
        Q!("    lea             " "rsi, [rsi + 0x40]"),
        Q!("    lea             " "rcx, [rcx + 0x80]"),
        Q!("    call            " Label!("Lbignum_kmul_32_64_local_bignum_kmul_16_32", 2, After)),
        ...
        Q!("    pop             " "rbp"),
        Q!("    pop             " "rbx"),
        // proc hoisting in -> ret after Lbignum_kmul_32_64_local_bignum_kmul_16_32
        Q!("    jmp             " Label!("hoist_finish", 3, After)),

        Q!(Label!("Lbignum_kmul_32_64_local_bignum_kmul_16_32", 2) ":"),
